  ...
  return (
    <div className={
      ...
      <div className={
        `${props.textStart ?
          'md:flex-row'
          : 'md:flex-row-reverse'} container w-full h-full px-10 lg:px-36 py-10 flex flex-col justify-center items-center`
      }>

        {/**text */}
        <div className='w-full md:w-3/5 h-fit md:h-full flex flex-col justify-start items-center'>
          <h3 className='w-full h-fit text-green-400 text-xs sm:text-sm lg:text-base text-start font-bold'>
            {props.subtitle}
          </h3>
          <h1 className='w-full h-fit mb-5 text-gray-950 text-base sm:text-lg lg:text-4xl text-start font-semibold'>
            {props.title}
          </h1>
          <p className='w-full h-fit text-slate-700 text-xs sm:text-sm lg:text-base text-justify'>
            {props.description}
          </p>
        </div>

        {/**image */}
        <div className='w-full md:w-2/5 h-fit flex flex-row justify-center items-center'>
          <Image
